...
import { MultilineInput } from "../../../../common/components/multiline-input/multiline-input";
...
export function CreateCompanyPanel() {
  ...
  return (
    ...
    >
      ...
      <FormSelect name="type" label="Tipo" placeholder="Selecciona el tipo de empresa" options={options} />
