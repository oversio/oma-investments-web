...
>(
  (
    ...
    const motionProps = React.useMemo(() => {
      if (Boolean(drawerMotionProps) && typeof drawerMotionProps === "object") {
    ...
    return (
      <>
        <Modal
          ...
          classNames={{
            ...classNames,
            wrapper: classMerge("!w-[var(--sidebar-width)]", classNames?.wrapper, {
            ...
            body: classMerge("p-0", classNames?.body),
            closeButton: classMerge("z-50", classNames?.closeButton),
          }}
          isOpen={isOpen}
          ...
          style={{
            // @ts-expect-error because I need to use the style prop
